...
def process_single_image(*, image_path: str):
    ...
    return [{"image_path": image_path, "texts": result}]
...
def process_folder_images(*, folder_path: str):
    ...
    for image_path in image_paths:
        ...
        results.append({"image_path": image_path, "texts": result})
    return results
...
def get_result_llm(prompt: str):
    ...
    completion = llm_api.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are a document reader bot that extract important demographics from a document. Data can be structured or unstructured and you don't have to make up the data.",
            },
